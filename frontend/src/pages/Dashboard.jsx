...
const Dashboard = () => {
  ...
  // IT WILL SHOW IF COMPLETE OF FILLED IT WILL DO ++.
  const fetchAllResumes =async ()=>{
    try {
      setLoading(true)
      const response = await axiosInstance.get(API_PATHS.RESUME.GET_ALL)
      //ADD COMPLELTE PERCENTAGE TO EACH RESUME
      ...
      <div className={styles.headerWrapper}>
        ...
        <div>
          ...
          <p className={styles.headerSubtitle}>
            ...
            :'start bulideing your professional resume'}
          </p>
        </div>
      ...
      {!loading && allResumes.length === 0 && (
        <div className={styles.emptyStateWrapper}>
          <div className={styles.emptyIconWrapper}>
            ...
            <p className={styles.emptyText}>You haven't create any resumes yet. Start building your Professional resume to load dream job.</p>
        ...
        <div className=' p-4'>
          <div className='flex flex-col items-center text-center'>
            <div className={styles.deleteIconWrapper}>
              <LucideTrash2 className=' text-orenge-600' size={24}/>
