...
const EditResume = () => {
  ...
  //TAKE BACK TO PREVIOUS FROM START OR TAKE BACK TO FIRST OR TO DASHBOARD
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
...
//ADDING NEW ITEM IE INFORMATION
  ...
  //FETCHING THE RESUME DETALES USING BACKEND URL
const fetchResumeDetailsById = async () => {
  ...
  //IT WILL HELP IN CHOOSING THE PERVIEW AS WELL AS HELPS IN DOWNLOADING THE RESUME ALSO SAVES THE RESUME AS A IMAGE.
...
const uploadResumeImages = async () => {
  try {
    ...
    // ✅ Fix tailwind colors (in-place)
    fixTailwindColors(thumbnailElement)
...
//THIS FUNCTION WILL HELP IN UPDATE THE RRESUMES AND PUT WILL HELP IN UPDATION ON BACKEND..
