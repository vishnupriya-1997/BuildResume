      ...
      ${isSelected ? 'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50':'border-gray-200 hover:border-violet-300'} `} onClick={onSelect}>
        {thumnailImg ?(
          <div className=" relative w-full h-full overflow-hidden">
           ...
           {isSelected &&(
            <div className=" absolute inset-0 bg-violet-50/10 flex items-center justify-center">
          ...
          <div className=" w-full h-[200px] flex items-center flex-col justify-center bg-grasient-to-br from-violet-50 
